<div class="notification">
    ...
    <div class="notification__message message--info">
        <h1><?php _("Info") ?></h1>
        <p><?php _("Lorem ipsum dolor sit amet consectetur adipisicing.") ?></p>
...
<script>
    ...
    const messageTitle = {
        info: <?php _("Info") ?>,
        success: <?php _("ImbaChat Success!") ?>,
        warning: <?php _("ImbaChat Warning!") ?>,
        danger: <?php _("ImbaChat Danger!") ?>
    }

    // possible values for the body of the message
    // end result of the emmet shortcut p*10>lorem10
    const messageText = {
        curl: <?php _("ImbaChat plugin requires php extension curl to be installed") ?>,
        online_sup: <?php _("Option "Online Support" is disabled, turn it on in "Chat Settings" page for getting access to ImbaSupport!") ?>,
        sunc_success: <?php _("The widget is successfully connected!") ?>,
        users_settings_success: <?php _("Settings saved successfully!") ?>,
        need_sync: <?php _("Please create or connect your plugin with ImbaChat.com") ?>
    };
