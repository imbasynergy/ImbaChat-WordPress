...
function ic_open_dialog_with( $atts, $content = null, $code = '' ) {
    ...
    return '<button type="button" class="'.$className.'" onclick="open_dialog('.$id.', `'.$jwt.'`, this)">'._($btnName).'</button>';
}
...
function ic_close_chat( $atts, $content = null, $code = '' ) {
    ...
    return '<button type="button" onclick="closeChat()">'._("Close ImbaChat").'</button>';
}
...
function ic_open_chat( $atts, $content = null, $code = '' ) {
    ...
    return '<button type="button" onclick="showChat()">'._("Open ImbaChat").'</button>';
}
...
function ic_create_group_with($atts, $content = null, $code = '') {
    ...
    return '<div id="ic_create_group_cont">
            <input class="'.$classNameI.'" placeholder="<?php _("Group name") ?>" type="text" id="ic_group_title">
            <input class="'.$classNameI.'" placeholder="<?php _("Pipe") ?>" type="text" id="ic_group_pipe">
            <button type="button" class="'.$classNameB.'" onclick="ic_create_dialog(this)">'._($btnName).'</button>
    </div>';
}
...
function ic_join_group($atts, $content = null, $code = '') {
    ...
    return '<button type="button" class="'.$classNameB.'" onclick="ic_join_group(`'.$atts['pipe'].'`, `'.$atts['name'].'`)">'._($btnName).'</button>';
}
