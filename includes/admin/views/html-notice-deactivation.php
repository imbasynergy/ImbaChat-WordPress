...
<div class="im-modal" id="im-deactivate-modal">
    <div class="im-quiz-wrapper">
        <div class="im-quiz-container">
            <h2><?php _('Why do you want deactivate our plugin?') ?></h2>
            <ul class="im-quiz">
            ...
            <div class="im-quiz-buttons">
                <form action="<?php echo admin_url( 'admin-post.php' ); ?>" method="post">
                    ...
                    <button type="submit" data-qa="send_and_deactivate" class="imbachat_warning"><?php _("Send & Deactivate") ?></button>
                </form>
                <a href="<?=$deactivate_url?>" data-qa="deactivate_button"><?php _("Deactivate") ?></a>
                <a href="#" onclick="document.getElementById('im-deactivate-modal').style.display = 'none'" data-qa="deactivation_cancel" class="imbachat_danger"><?php _("Cancel") ?></a>
            </div>
        </div>
    </div>
</div>